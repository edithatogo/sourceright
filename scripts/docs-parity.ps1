...
$ParityMap = @{
    ...
    "release-surface-refresh.md"            = "docs-site/src/content/docs/guides/release-surface-refresh.md"
    "submission-contracts.md"               = "docs-site/src/content/docs/submission-contracts.md"
