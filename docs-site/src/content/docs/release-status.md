...
| Smithery | accepted | 0.1.20 | <https://smithery.ai/servers/edithatogo/sourceright> (release `263ee636-5d24-4010-9dd9-e199d4f7b848`); `smithery-mcpb-publish-2026-06-10.md` and install smoke in `smithery-install-smoke-2026-06-10.md`. | 2026-06-10 | Install via `npx -y @smithery/cli@latest run edithatogo/sourceright`. |
