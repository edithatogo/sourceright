...
description: Comprehensive registry completion table for all publication surfaces.
---
...
| Smithery | accepted | 0.1.20 | <https://smithery.ai/servers/edithatogo/sourceright> (release `263ee636-5d24-4010-9dd9-e199d4f7b848`); `smithery-mcpb-publish-2026-06-10.md` and install smoke in `smithery-install-smoke-2026-06-10.md`. | 2026-06-10 | MCPB listing and install smoke evidence are recorded; public acceptance is bounded to the verified release evidence. |
...
For the full publishing plan see [Publishing Plan](guides/publishing).
