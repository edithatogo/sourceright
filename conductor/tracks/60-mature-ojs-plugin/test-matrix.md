...
| Live smoke | Optional OJS test instance smoke passes or skips cleanly. | `ojs-install-smoke.md` documents the manual and Docker candidate test path. Live OJS instance smoke remains opt-in and deferred; the default CI path is fixture-backed only. |
