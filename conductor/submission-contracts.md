...
document is the canonical internal contract. The public mirrors in
`docs/src/submission-contracts.md` and `docs-site/src/content/docs/submission-contracts.md`
must stay aligned with `conductor/submission-requirements.json`.
...
An explicit human approval gate is required before any external issue, pull
request, listing, or registry submission is created.
