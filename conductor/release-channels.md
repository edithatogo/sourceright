...
| Zotero plugin | `.xpi` or adapter package | GitHub Release, Zotero forum/listing path | 58, 69 | Prepared as CLI/Web API adapter; no `.xpi` or Plugin Gallery listing claimed until package validation, install notes, disposable-library smoke, and accepted listing evidence exist. |
| OJS plugin | OJS/PKP plugin package | GitHub Release, PKP/OJS Plugin Gallery readiness | 60, 69 | Prepared as generic-plugin source skeleton; PKP Gallery acceptance requires package install, permission docs, fixture and optional test-instance smoke, and accepted listing evidence. |
...
| LibreOffice extension | `.oxt` package | LibreOffice Extensions site or GitHub Release | 68, 69 | Explicitly deferred until package build, install/uninstall smoke, Writer fixture, reversible write plan, and accepted listing evidence exist. |
