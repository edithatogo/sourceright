...
| --- | --- | --- |
| 00 Public repo infrastructure | planned | Public GitHub repo, license, CI/CD, Pages, security, release plumbing. |
| 01 Product roadmap | planned | Product boundaries, v1 academic workflow, later legal and claim/provenance roadmap. |
| 02 Legacy audit | planned | Audit imported `humanizer-next` behavior, fixtures, and reusable ideas. |
| 03 Reference intake | planned | Extract references from text, Markdown, DOCX, then PDF/OCR. |
| 04 CSL canonical model | planned | Use CSL JSON as the canonical reference data model. |
| 05 Verification sidecar | planned | Store provenance, provider matches, confidence, conflicts, and review state. |
| 06 Academic providers | planned | Crossref first, then DOI, DataCite, OpenAlex, PubMed/NCBI, ORCID. |
| 07 Standardisation cleaning | planned | Normalize fields, identifiers, duplicates, and style-independent reference data. |
...
| 11 Export suite | planned | XML, ENW, RIS, BibLaTeX, and YAML outputs with validation. |
| 12 CLI and MCP | planned | CLI command family and MCP server tools/resources/prompts. |
