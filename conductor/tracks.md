...
| 65 AI client MCP packaging | pending | Document and prove Claude, Codex, GitHub Copilot, and generic MCP-client packaging boundaries without overclaiming host plugins. |
