...
| 34 Coverage verification and reporting | in_progress | Make the 85 percent coverage floor measurable, reproducible, and visible in hooks, CI, and reports. |
| 35 Public docs cutover and launch | in_progress | Finalise the Starlight/Astro docs migration, redirects, and archive cutover for the public site. |
...
| 52 Non-provider pipeline plugins | in_progress | Implement local bibliographic matching, recency/retraction policy checks, claim-source relevance, and DOCX/PDF extraction plugin contracts. |
...
| 61 Streamlit app publication and hardening | in_progress | Make the Streamlit demo deployable, synthetic-data-only, smoke-tested, and clearly separated from the static Pages demo. |
