...
DOCX and PDF support remains adapter-text based in this technical preview. The
intake layer keeps original line spans after reference-section trimming, keeps
wrapped bibliography entries together, and emits
