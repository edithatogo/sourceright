...
release-surface evidence boundaries validation, not marketplace acceptance: prepared or
deferred metadata must not be described as publicly listed or installable until
an independently verifiable public URL, version, or artifact is available.
